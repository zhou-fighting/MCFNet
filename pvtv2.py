...
class PyramidVisionTransformerV2(nn.Module):
    def __init__(self, img_size=384, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
...
def pvt_v2_b0(pretrained=False, **kwargs):
    ...
    if pretrained:
        state_dict = torch.load('./ckps/pvtv2/pvt_v2_b0.pth')
...
def pvt_v2_b1(pretrained=False, **kwargs):
    ...
    model.default_cfg = _cfg()
    if pretrained:
        state_dict = torch.load('./ckps/pvtv2/pvt_v2_b1.pth')
        state_dict.pop('head.weight')
        state_dict.pop('head.bias')
        model.load_state_dict(state_dict)
    return model
...
def pvt_v2_b2(pretrained=False, **kwargs):
    ...
    model.default_cfg = _cfg()
    if pretrained:
        # state_dict = load_state_dict_from_url(model_urls['pvt_v2_b2'], map_location='cuda')
        state_dict = torch.load('./ckps/pvtv2/pvt_v2_b2.pth')
        state_dict.pop('head.weight')
        state_dict.pop('head.bias')
        model.load_state_dict(state_dict)
    return model
...
def pvt_v2_b3(pretrained=False, **kwargs):
    ...
    model.default_cfg = _cfg()
    if pretrained:
        state_dict = torch.load('./ckps/pvtv2/pvt_v2_b3.pth')
        state_dict.pop('head.weight')
        state_dict.pop('head.bias')
        model.load_state_dict(state_dict)
    return model
...
def pvt_v2_b4(pretrained=False, **kwargs):
    ...
    model.default_cfg = _cfg()
    if pretrained:
        state_dict = torch.load('./ckps/pvtv2/pvt_v2_b4.pth')
        state_dict.pop('head.weight')
        state_dict.pop('head.bias')
        model.load_state_dict(state_dict)
    return model
...
def pvt_v2_b5(pretrained=False, **kwargs):
    ...
    model.default_cfg = _cfg()
    if pretrained:
        state_dict = torch.load('./ckps/pvtv2/pvt_v2_b5.pth')
        state_dict.pop('head.weight')
        state_dict.pop('head.bias')
        model.load_state_dict(state_dict)
    return model
