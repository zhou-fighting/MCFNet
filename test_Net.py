...
parser.add_argument('--test_path', type=str, default='./RGB-D dataset/test_data/', help='test dataset path')
parser.add_argument('--save_path', type=str, default='./test_maps/MCFNet/', help='save path')
parser.add_argument('--pth_path', type=str, default='./ckps/MCFNet_mae_best.pth', help='checkpoint path')
